...
namespace Learun.Application.Web.Areas.LR_CodeDemo.Controllers
{
    ...
    public class SettlementsController : MvcControllerBase
    {
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = settlementsIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var tc_SettlementsData = settlementsIBLL.Gettc_SettlementsEntity( keyValue );
            var jsonData = new {
        ...
        {
            settlementsIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
