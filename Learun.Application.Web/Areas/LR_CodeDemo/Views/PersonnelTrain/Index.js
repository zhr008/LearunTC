        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                ...
                headData: [
                    ...
                    { label: "培训证书类型", name: "F_CertType", width: 100, align: "left"},
                    { label: "培训专业序列", name: "F_MajorType", width: 100, align: "left"},
                    { label: "培训证书专业 ", name: "F_Major", width: 100, align: "left"},
                    { label: "培训发证机构", name: "F_CertOrganization", width: 100, align: "left"},
                    { label: "预定发证日期", name: "F_CertDateBegin", width: 100, align: "left"},
                    { label: "证书失效日期", name: "F_CertDateEnd", width: 100, align: "left"},
                    ...
                    { label: "报名培训状态", name: "F_TrainStatus", width: 100, align: "left",
                        formatterAsync: function (callback, value, row, op,$cell) {
                             learun.clientdata.getAsync('dataItem', {
                                 key: value,
                                 code: 'TrainStatus',
                    ...
                    { label: "登记日期", name: "F_CheckInDate", width: 100, align: "left"},
                    { label: "报名截止日期", name: "F_ApplyDate", width: 100, align: "left"},
                    { label: "预计培训日期", name: "F_ExpectedTrainDate", width: 100, align: "left"},
                    { label: "报考收费标准", name: "F_FeeStandard", width: 100, align: "left"},
                    { label: "报考收费状态", name: "F_TrainCollectStatus", width: 100, align: "left",
                        formatterAsync: function (callback, value, row, op,$cell) {
                             learun.clientdata.getAsync('dataItem', {
                                 key: value,
                    ...
                    { label: "付费代理机构", name: "F_TrainOrgName", width: 100, align: "left"},
                    { label: "代理机构开户行", name: "F_TrainOrgBankName", width: 100, align: "left"},
                    { label: "代理机构银行账号", name: "F_TrainOrgBankAccount", width: 100, align: "left"},
                    { label: "付费金额", name: "F_TrainPayAmount", width: 100, align: "left"},
                    { label: "付费凭证", name: "F_TrainPayVoucher", width: 100, align: "left",
                        formatterAsync: function (callback, value, row, op,$cell) {
                             learun.clientdata.getAsync('dataItem', {
                                 key: value,
                    ...
                    { label: "付费状态", name: "F_TrainPayStatus", width: 100, align: "left",
                        formatterAsync: function (callback, value, row, op,$cell) {
                             learun.clientdata.getAsync('dataItem', {
                                 key: value,
                                 code: 'TrainPayStatus',
