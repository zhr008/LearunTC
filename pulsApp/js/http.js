...
(function ($, learun, fui, window) {
    ...
    learun.http = {
        ...
        webget: function (url, param, callback, dataType) {
            url = encodeURI(url);			
			if (window.plus &&(window.plus.device.model.indexOf('iphone') != -1 || window.plus.device.model.indexOf('iPhone') != -1)) {
				plus.io.resolveLocalFileSystemURL("_www/" + url, function( entry ) {
