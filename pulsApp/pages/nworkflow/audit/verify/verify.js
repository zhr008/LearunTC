        ...
        init: function ($page, param) {
            ...
            $header.find('.lr-form-header-submit').on('tap', function () {
                ...
                setTimeout(function () {
					...
					formdata.signUrl = $sigdiv.jSignature("getData");
			...
			if(param.isSign == '1'){
				$page.find('.signaturebar').show();
				var $sigdiv = $page.find('#signature').jSignature({ 'UndoButton': false, height:'150px',width:'100%' });
				$page.find('#btn_signature_reset').on('tap',function(){
