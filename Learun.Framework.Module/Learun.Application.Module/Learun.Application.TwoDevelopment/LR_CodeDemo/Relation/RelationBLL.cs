...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：1231
    /// </summary>
    public class RelationBLL : RelationIBLL
    {
        ...
        public IEnumerable<tc_RelationEntity> GetList(string queryJson)
        {
            try
            {
                return RelationService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<tc_RelationEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return RelationService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<RelationDeatil> GetRelationDetail(string ProjectDetailId)
        {
            ...
            try
            {
                return RelationService.GetRelationDetail(ProjectDetailId);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public tc_RelationEntity GetEntity(string keyValue)
        {
            try
            {
                return RelationService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                RelationService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, tc_RelationEntity entity)
        {
            try
            {
                RelationService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
