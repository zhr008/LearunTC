<template>
  <view class="lr-datetime-picker">
    <view
      ...
      catchtouchmove="true"
    ></view>
    <view class="lr-datetime-content" :class="{ show: showPicker }">
      <view class="lr-datetime-hd" @touchmove.stop.prevent catchtouchmove="true">
        <view class="lr-datetime-btn" @tap.stop="pickerCancel">取消</view>
        <view class="lr-datetime-btn" :style="{ color: color }" @tap.stop="pickerConfirm">确定</view>
      </view>
      <view class="lr-datetime-view">
        ...
        >
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.years" :key="index">{{ item }}年</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.months" :key="index">{{ item }}月</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.days" :key="index">{{ item }}日</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.hours" :key="index">{{ item }}时</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.minutes" :key="index">{{ item }}分</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.seconds" :key="index">{{ item }}秒</view>
          </picker-view-column>
        </picker-view>
        <picker-view
          v-else
        ...
        >
          <picker-view-column class="yu-picker-column">
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.dates" :key="index">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view class="lr-datetime-item" v-for="(item, index) in dateObj.hours" :key="index">{{ item }}时</view>
          </picker-view-column>
...
export default {
  ...
  props: {
    ...
    //颜色
    color: { type: String, default: '#1aad19' },
    //开始年份
    startYear: { type: [String, Number], default: '1900' },
    //结束年份
    endYear: { type: [String, Number], default: '2100' },
    //设置默认日期时间
